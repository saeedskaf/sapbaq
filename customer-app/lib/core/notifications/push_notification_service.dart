...
class PushNotificationService {
  ...
  /// launch); the app observes this and navigates, then clears it.
  ...
  /// Foreground pushes, so app-level state (unread badges, inboxes) can refresh
  /// while the user is looking at the app instead of going stale.
  ...
  Future<void> _onForegroundMessage(RemoteMessage message) async {
    // Let app-level state (unread badges, inboxes) react before we draw
    // anything — this fires on every platform.
