...
/// Metadata returned by every OTP send endpoint: how long until the next resend
/// is allowed (the server computes the escalating backoff — the app just mirrors
/// the number) and how long the code stays valid.
class OtpSendMeta {
