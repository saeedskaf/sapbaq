...
/// the language of bilingual text fields (product/mosque names, order data…).
/// Reading from a [ValueListenable] means a language switch in settings takes
/// effect on the very next request with no client restart.
