...
/// A yes/no confirmation dialog. Resolves to true only when the user confirms.
/// [danger] paints the confirm action in the error colour (destructive intent).
Future<bool?> showConfirmDialog(
  ...
  return showDialog<bool>(
    ...
    builder: (dialogContext) => AlertDialog(
      title: title == null ? null : TextCustom.subheading(text: title),
      content: TextCustom(text: message, fontSize: 14),
      actions: [
        TextButton(
          onPressed: () => Navigator.pop(dialogContext, false),
          child: TextCustom(text: l10n.cancelButton, fontSize: 14),
        ),
        TextButton(
          ...
          child: TextCustom(
            ...
            color: danger ? context.colors.danger : context.colors.primary,
          ),
        ),
      ],
    ),
