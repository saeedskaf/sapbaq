...
/// A 6-cell verification-code entry (ported from the customer app). Renders the
/// typed digits over a real (transparent) text field so the OS keyboard, paste,
/// and SMS autofill all work; taps anywhere focus the field. Direction-neutral
/// (always fills left→right). When all six digits are entered it fires
/// [onCompleted] once — callers use that to dismiss the keyboard and advance.
