...
/// Mosque-representative passcode length (Sapbaq_AUTH_Flow style).
const int kPasscodeLength = 4;

/// A 4-cell passcode entry (ported from the customer app). Renders filled dots
/// over a real (transparent) text field so the OS keyboard, paste, and
/// autofill-from-SMS all work; taps anywhere focus the field.
/// Direction-neutral (always fills left→right).
