...
/// wait is server-authoritative (escalating 30→60→120→300); callers just record
/// the seconds the server returned.
class OtpCooldownStore {
  static String _key(String scope) => 'otp_cooldown_${scope.hashCode}';

  /// Record a cooldown of [seconds] for [scope] (e.g. `rep_forgot:+965…`).
